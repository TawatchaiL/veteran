$.widget("ui.datepicker_thai", {
    _init: function () {
        ...
        "yy" == t[0]
            ...
            ? ((s = 2), (r = 0), (q = 1))
            : ((s = 1), (r = 0), (q = 2)),
            i && (a.datepicker("option", "dayNamesMin", ["อา", "จ", "อ", "พ", "พฤ", "ศ", "ส"]), a.datepicker("option", "monthNamesShort", g), a.datepicker("option", "monthNames", g)),
            h &&
                (0 == m &&
                    (a.datepicker("option", "beforeShow", function () {
                        if (
                            (setTimeout(function () {
                                $.each(l.find(".ui-datepicker-year"), function (a, b) {
                                    l.find(".ui-datepicker-year").eq(a).find(":selected").length > 0
                                        ? $.each($(".ui-datepicker-year:eq(" + a + ") option"), function (b, c) {
                                              var d =
                                                  parseInt(
                                                      $(".ui-datepicker-year:eq(" + a + ") option")
                                                          .eq(b)
                                                          .val()
                                                  ) + 543;
                                              $(".ui-datepicker-year:eq(" + a + ") option")
                    ...
                    a.datepicker("option", "onClose", function () {
                        if (
                            (j ||
                                $.each(l.find(".ui-datepicker-year"), function (a, b) {
                                    (c = l.find(".ui-datepicker-year").eq(a).text()),
                                        (d = parseInt(c) - 543),
                                        h &&
                                            setTimeout(function () {
                ...
                1 == m &&
                    ($.each(a.find(".ui-datepicker-year"), function (b, e) {
                        a.find(".ui-datepicker-year").eq(b).find(":selected").length > 0
                            ? $.each($(".ui-datepicker-year:eq(" + b + ") option"), function (a, c) {
                                  var d =
                                      parseInt(
                                          $(".ui-datepicker-year:eq(" + b + ") option")
                                              .eq(a)
                                              .val()
                                      ) + 543;
                                  $(".ui-datepicker-year:eq(" + b + ") option")
                    ...
                    a.datepicker("option", "onChangeMonthYear", function (b, e, f) {
                        $.each(a.find(".ui-datepicker-year"), function (b, e) {
                            a.find(".ui-datepicker-year").eq(b).find(":selected").length > 0
                                ? $.each($(".ui-datepicker-year:eq(" + b + ") option"), function (a, c) {
                                      var d =
