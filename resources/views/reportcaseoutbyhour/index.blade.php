...
@section('style')
    @include('reportcaseoutbyhour.style')
@endsection
              ...
              <div class="row mb-2">
                ...
                <div class="col-sm-6">
                  <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Callcenter Report</li>
                  </ol>
                </div>
              </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa-solid fa-magnifying-glass"></i> ผลรวมสายเข้าภายนอกแยกตามช่วงเวลา</h3>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa-solid fa-print"></i> ผลรวมสายเข้าภายนอกแยกตามช่วงเวลา</h3>
                            <div class="card-tools">
...
@endsection
@section('script')
    @include('reportcaseoutbyhour.script')
@endsection
