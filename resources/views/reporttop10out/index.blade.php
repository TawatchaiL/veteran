                ...
                <div class="col-12">
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa-solid fa-magnifying-glass"></i> 10 อันดับเบอร์ภายนอก</h3>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa-solid fa-print"></i> 10 อันดับเบอร์ภายนอก</h3>
                            <div class="card-tools">
