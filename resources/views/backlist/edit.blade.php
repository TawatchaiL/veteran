        ...
        <form id="editdata" class="form" action="" method="POST">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <h4 class="modal-title" id="exampleModalLongTitle"><i class="fas fa-list-ol"></i> แก้ไข แบล็กลิสต์
                    </h4>
                            ...
                            <div class="row">
                                <div class="col-xs-8 col-sm-8 col-md-8">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('phone', null, ['id' => 'Editphone', 'placeholder' => 'เบอร์โทรศัพท์', 'class' => 'form-control']) !!}
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-8 col-sm-8 col-md-8">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('description', null, ['id' => 'Editdescription', 'placeholder' => 'เหตุผล', 'class' => 'form-control']) !!}
                                    </div>
                                </div>
                            </div>
                        {!! Form::close() !!}
