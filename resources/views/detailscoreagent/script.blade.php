            ...
            columns: [
                {
                    text: [  
                                                ...
                                                '\n',
                                                { text: 'Report : Summary Performance By Agent (ผลรวมการประเมินความพึงพอใจ ราย Agent ที่รับสาย)', alignment: 'left', fontSize: 18, margin: [0, 50, 70, 0] },
                                                '\n',
        ...
        let options = {
            ...
            let optionsdonut = {
                ...
                success: function(res) {
                    alert(JSON.stringify(res.datag));
