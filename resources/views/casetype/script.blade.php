                    ...
                    success: function(res) {
                        ...
                        $.each(res.data, function(index, item) {
                            $('#targettext').append(
                                ...
                                + '<div class="col-xs-1 col-sm-1 col-md-1"><div class="input-group">&nbsp;<button type="button" class="btn btn-success" id="SubmitNewCasetype"><i class="fa-solid fa-angle-up"></i></button></div></div>' 
                                + '<div class="col-xs-1 col-sm-1 col-md-1"><div class="input-group">&nbsp;<button type="button" class="btn btn-success" id="SubmitNewCasetype"><i class="fa-solid fa-angle-down"></i></button></div>' 
                                + '</div></div>');
/*
                            $('#targettext').append(
