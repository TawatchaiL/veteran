        ...
        <div class="single contact-info">
            ...
            <ul class="list-unstyled">
                <li>
                    <div class="icon"><i class="fa-regular fa-comment-dots"></i></div>
                    <div class="info">
                        <p><strong>การแสดงความคิดเห็น</strong> <br>&nbsp;{{ $casecomment->comment !== '' ? $casecomment->comment : '-'  }}</p>
                    </div>
                </li>
...
<div class="row justify-content-end">
    <button type="button" data-case_id="{{ $cases->id }}" class="btn btn-success listcomment-button" id="ListcommentButton"><i class="fa-solid fa-backward"></i>
        ย้อนกลับ</button>&nbsp;
