                ...
                <div class="card card-success card-tabs">
                    <div class="card-header p-0 pt-1">
                        <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link disabled" id="custom-tabs-one-comment-tab" data-toggle="pill"
                            ...
                            <li class="nav-item">
                                <a class="nav-link disabled" id="custom-tabs-one-commentlog-tab" data-toggle="pill"
                            ...
                            <div class="tab-pane fade" id="custom-tabs-one-comment" role="tabpanel"
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-xs-6 col-sm-6 col-md-6">
                                                    <strong><i class="fas fa-code"></i> HN : </strong><div id="cHn"></div>                                              
                                            </div>
                                            <div class="col-xs-6 col-sm-6 col-md-6">
                                                    <strong><i class="fas fa-user-tie"></i> ชื่อ-สกุล : </strong><div id="cName"></div>                                    
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="col-xs-6 col-sm-6 col-md-6">
                                                    <strong><i class="fa-regular fa-message"></i> ประเภทเคส : </strong><div id="cCasetype1"></div>
                                            </div>
                                            <div class="col-xs-6 col-sm-6 col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-6 col-sm-6 col-md-6">
                                                    <strong><i class="fa-regular fa-message"></i> รายละเอียดเคสย่อย : </strong><div id="cCasetype3"></div>
                                            </div>
                                            <div class="col-xs-6 col-sm-6 col-md-6">
                                                <strong><i class="fa-regular fa-message"></i> รายละเอียดเคส เพิ่มเติม 1 : </strong><div id="cCasetype4"></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xs-6 col-sm-6 col-md-6">
                                                    <strong><i class="fa-regular fa-message"></i> รายละเอียดเคส เพิ่มเติม 2 : </strong><div id="cCasetype5"></div>
                                            </div>
                                            <div class="col-xs-6 col-sm-6 col-md-6">
                                                <strong><i class="fa-regular fa-message"></i> รายละเอียดเคส เพิ่มเติม 3 : </strong><div id="cCasetype6"></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-xs-6 col-sm-6 col-md-6">
                                                    <strong><i class="fas fa-shuffle"></i> สถานะการโอนสาย : </strong><div id="cTranferstatus"></div>
                                            </div>
                                            <div class="col-xs-6 col-sm-6 col-md-6">
