                    ...
                    <ol class="breadcrumb float-sm-right">
                        ...
                        @can('outbound-create')
                            <button type="button" class="btn btn-success" id="CreateButton">
                                <i class="fas fa-list-ol"></i> เพิ่มรายการ โทรออก </a> </button>
                        @else
                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-list-ol"></i> รายการโทรออก (Outbound) </h3>
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form method="post" action="{{ route('outbound.destroy_all') }}" name="delete_all"
                                id="delete_all">
                                @csrf
                                @method('POST')
