        ...
        <div class="card card-success card-outline card-outline-tabs">
            <div class="card-header p-0 pt-1">
                <ul class="nav nav-tabs" id="custom-tabs-one-tabp" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link tablistcaseP" id="custom-tabs-one-casedetail-tabp{{$cardid}}" data-contactid="@if ($contactd[0]->id != '') {{ $contactd[0]->id }} @else {{null}} @endif" data-toggle="pill"
