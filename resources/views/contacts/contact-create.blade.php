<div class="row" style="display: flex; justify-content: center; align-items: center;">
    <div class="col-md-12 col-sm-12 col-lg-12">
        ...
        <div class="text-end"><input type="hidden" value="{{count($contactd)}}" name="contractid{{$cardid}}" id="contractid{{$cardid}}"><input type="hidden" value="{{ $telephone }}" name="telnop{{$cardid}}" id="telnop{{$cardid}}">
