...
<div class="card card-success card-tabs">
        ...
        <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill" href="#custom-tabs-one-home"
                    role="tab" aria-controls="custom-tabs-one-home" aria-selected="true">ข้อมูลผู้ติดต่อ</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="custom-tabs-one-profile-tab" data-toggle="pill" href="#custom-tabs-one-profile"
                    role="tab" aria-controls="custom-tabs-one-profile" aria-selected="false">ข้อมูลอื่นๆ</a>
            </li>
    ...
    <div class="card-footer">
        <button type="button" class="btn btn-success" id="SubmitCreateFormPOP"><i class="fas fa-download"></i>
            บันทึกข้อมูล</button>
