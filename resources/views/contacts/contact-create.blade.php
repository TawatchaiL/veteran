<div class="row" style="display: flex; justify-content: center; align-items: center;">
    <div class="col-md-12 col-sm-12 col-lg-12">
        ...
        <div class="text-end"><input type="hidden" value="" name="contractid{{$cardid}}" id="contractid{{$cardid}}"><input type="hidden" value="{{ $telephone }}" name="telnop{{$cardid}}" id="telnop{{$cardid}}">
                ...
                <ul class="nav nav-tabs" id="custom-tabs-one-tabp" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="custom-tabs-one-address-tabp{{$cardid}}" data-toggle="pill"
                            href="#custom-tabs-one-addressp{{$cardid}}" role="tab" aria-controls="custom-tabs-one-addressp{{$cardid}}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('adddatep'.$cardid, date('Y-m-d', strtotime(date('Y-m-d') . ' +543 years')), [
                                        'id' => 'adddatep'.$cardid,
        ...
        <div class="modal-footer {{-- justify-content-between --}}">
            <button type="button" class="btn btn-success SubmitCreateFormP-button" data-id="" data-tabid="{{ $cardid }}" data-uniqid="{{ $cardid }}" id="SubmitCreateFormP{{$cardid}}"><i class="fas fa-download"></i>
                บันทึกข้อมูล</button>
    </div>
