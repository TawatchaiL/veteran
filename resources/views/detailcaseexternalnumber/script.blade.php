            ...
            buttons: [
                ...
                { // กำหนดพิเศษเฉพาะปุ่ม pdf
                    ...
                    customize: function(doc) {
                                ...
                                columns: [
                                    {
                                        text: [  
                                                ...
                                                '\n',
                                                { text: 'Report : Detail External Number (รายละเอียดเบอร์ภายนอกที่โทรเข้ามาติดต่อ)', alignment: 'left', fontSize: 18, margin: [0, 50, 70, 0] },
                                                '\n',
                        ...
                        doc.content[0].table.widths = [40, '*', 80, 140, 70, 70];
                        var objLayout = {};
