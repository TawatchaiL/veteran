    ...
    <div class="modal-dialog modal-dialog-in modal-lg {{-- modal-dialog-centered --}}" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="alert alert-danger alert-in alert-dismissible fade show" role="alert"
                    style="display: none;">
                    <button type="button" class="btn-close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="alert alert-success success-in alert-dismissible fade show" role="alert"
                    style="display: none;">
            ...
            <div class="modal-body">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <div class="form-group">
                        ...
                        <select style="width: 100%;" class="users select2 select2_single form-control" id="AddUser"
                            name="user" multiple="multiple" readonly>
                            <!-- <option value="" selected>Select Student</option>
                                                                                                                                                                                                                                                                                                                                                                                <option value="" selected>Select Parent</option>-->
                            {{--   @foreach ($position as $key)
                                <option value="{{ $key->id }}">{{ $key->name }}
...
<!-- Inner Modal4 -->
<div class="modal fade innerm" id="innerModal4" tabindex="-1" role="dialog" aria-labelledby="innerModalLabel"
    aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-dialog-in4 {{-- modal-dialog-centered --}}" role="document">
        <div class="modal-content">
            <!-- Inner Modal Header -->
            <div class="modal-header bg-primary">
                <h4 class="modal-title" id="innerModalLabel">ลงลายเซ็นต์</h4>
                <button type="button" class="close" data-dismiss-modal="modal4" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <!-- Inner Modal Body -->
            ...
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-success" id="SubmitCreateFormIn4">บันทึกลายเซ็นต์</button>
                {{-- <button type="button" class="btn btn-danger" id="clear-signature">ล้างลายเซ็นต์</button> --}}
            </div>
        </div>
    </div>
</div>
