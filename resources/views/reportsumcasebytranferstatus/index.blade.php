...
@section('style')
    @include('reportsumcasebytranferstatus.style')
@endsection
                ...
                <div class="col-12">
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa-solid fa-magnifying-glass"></i> ผลรวมเรื่องที่ติดต่อแยกตามสถานะการโอนสาย</h3>
...
@section('script')
    @include('reportsumcasebytranferstatus.script')
@endsection
