        ...
        var table = $('#Listview').DataTable({
            ...
            buttons: [
                'copy',
                {
                    extend: 'excel',
                    text: 'Excel',
                    title: 'ผลรวมแยกเรื่องที่ติดต่อแยกตามสถานะ',
                    exportOptions: {
                                ...
                                columns: [
                                    {
                                        text: [  
                                                ...
                                                '\n',
                                                { text: 'Report : Sum Case By Status (ผลรวมแยกเรื่องที่ติดต่อแยกตามสถานะ)', alignment: 'left', fontSize: 18, margin: [0, 50, 70, 0] },
                                                '\n',
...
//                    className: 'no-print'
    ...
    function Loadchart(){
        let options = {
                ...
                title: {
                        text: 'ผลรวมแยกเรื่องที่ติดต่อแยกตามสถานะ',
                        align: 'center',
                        style: {
                            fontSize: '16px',
                            fontWeight: 'bold',
            ...
            let optionsdonut = {
                ...
                var rstatus = 'report';
                $.ajax({
                url: '{{ route('reportsumcasebystatus') }}',
                data: {
                    sdate: rdate,
                    rstatus: rstatus
                },
