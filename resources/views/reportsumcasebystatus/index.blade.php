...
@section('style')
    @include('reportsumcasebystatus.style')
@endsection
                ...
                <div class="col-12">
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa-solid fa-magnifying-glass"></i> ผลรวมแยกเรื่องที่ติดต่อแยกตามสถานะ</h3>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa-solid fa-print"></i> ผลรวมแยกเรื่องที่ติดต่อแยกตามสถานะ
                            </h3>
                            <div class="card-tools">
...
@section('script')
    @include('reportsumcasebystatus.script')
@endsection
