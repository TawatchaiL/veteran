            ...
            buttons: [
                ...
                { // กำหนดพิเศษเฉพาะปุ่ม pdf
                    ...
                    doc.defaultStyle = {
                                ...
                                columns: [
                                    {
                                        text: [  
                                                ...
                                                '\n',
                                                { text: 'Report : Detail Case Edit And Comment(รายละเอียดเรื่องที่ติดต่อที่มีการ แก้ไข และการคอมเม้น)', alignment: 'left', fontSize: 18, margin: [0, 50, 70, 0] },
                                                '\n',
                        ...
                        doc.content[0].table.widths = [180, 80, 80, 80, '*', 130];
                        var objLayout = {};
