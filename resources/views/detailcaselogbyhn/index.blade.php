...
@section('style')
    @include('detailcaselogbyhn.style')
@endsection
@section('content')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-address-print"></i>รายละเอียดเรื่องที่ติดต่อที่มีการ แก้ไข และการคอมเม้น
                            </h3>
...
@endsection
@section('script')
    @include('detailcaselogbyhn.script')
@endsection
