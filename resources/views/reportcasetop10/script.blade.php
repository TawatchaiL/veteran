            ...
            buttons: [
                ...
                },
                {
                    ...
                    customize: function(win) {
                        ...
                        $(win.document.body).prepend('<img style="position:absolute; top:0; left:480;width:100" src='+logobase64+'>')
                        $(win.document.body).find('h1').css('text-align', 'center').css('font-size','16px').css('margin-top','100px');
                        $(win.document.body).find('table').addClass('display').css('font-size','12px').removeClass('dataTable').css('margin-top','80px').css('margin-bottom','60px');
