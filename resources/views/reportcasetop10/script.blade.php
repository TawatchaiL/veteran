            ...
            buttons: [
                ...
                },
                {
                    ...
                    customize: function(win) {
                        ...
                        $(win.document.body).prepend('<img style="position:absolute; top:0; left:500;width:50" src='+logobase64+'>')
                        $(win.document.body).find('h1').css('text-align', 'center').css('font-size','12px').css('margin-top','65px');
