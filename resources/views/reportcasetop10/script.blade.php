            ...
            buttons: [
                ...
                },
                {
                    ...
                    customize: function(win) {
                        ...
                        $(win.document.body).prepend('<img style="position:absolute; top:10; left:600;width:50" src='+logobase64+'>')
                                            .prepend('<div style="position:absolute; top:50; right:0;">My Title</div>')
