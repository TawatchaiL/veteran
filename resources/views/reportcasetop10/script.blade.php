            ...
            buttons: [
                ...
                },
                {
                    ...
                    customize: function(win) {
                        ...
                        $(win.document.body).prepend('<img style="position:absolute; top:0; left:500;width:100" src='+logobase64+'>')
                        $(win.document.body).find('h1').css('text-align', 'center').css('font-size','16px').css('margin-top','80px');
