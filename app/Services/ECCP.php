...
class ECCP
{
    ...
    public function setAgentNumber($sAgentNumber)
    {
        $this->_agentNumber = $sAgentNumber;
    }
    public function setAgentPass($sAgentPass)
    {
        $this->_agentPass = $sAgentPass;
    }
    ...
    {
        return array_shift($this->_listaEventos);
    }
