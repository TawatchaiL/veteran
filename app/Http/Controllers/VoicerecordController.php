            ...
            return datatables()->of($datas)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    if (Gate::allows('contact-edit')) {
                        ...
                        $html .= '<a href="#" class="btn btn-success changeUrlButton" onclick="formModal(\'' . route('voicerecord.edit', $row->id) . '\')" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-container="body" data-bs-title="Create New Student"> <i class="fa fa-plus"></i> Create New Student test </a>';
                    } else {
