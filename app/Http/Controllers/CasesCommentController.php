            ...
            return datatables()->of($datas)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    if (Gate::allows('case-delete')) {
                        $html .= '<button type="button" data-rowid="' . $row->id . '" class="btn btn-sm btn-success btn-viewcomment"><i class="fa-regular fa-clipboard"></i> การแสดงความคิดเห็น</button>';
                    } else {
                        $html .= '<button type="button" class="btn btn-sm btn-success disabled" data-toggle="tooltip" data-placement="bottom" title="คุณไม่มีสิทธิ์ในส่วนนี้"><i class="fa-regular fa-clipboard"></i> การแสดงความคิดเห็น</button> ';
                    }
                    return $html;
