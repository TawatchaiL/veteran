        ...
        if (!$agents->isEmpty()) {
            foreach ($agents as $agent) {
                ...
                if ($agent->phone_status_id == 0) {
                    ...
                    <button class="btn dropdown-item btn-insert"  data-id="' . $agent->phone . '"><i class="fa-solid fa-user-secret"></i> ดักฟัง</button>
                    <button class="btn dropdown-item btn-spy"  data-id="' . $agent->phone . '"><i class="fa-solid fa-user-group"></i> แทรกสาย</button>
