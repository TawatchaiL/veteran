            ...
            ->table('call_center.timeslot')
                    ...
                    ->leftJoin(DB::raw("(SELECT
                        ...
                        SUM(CASE
                            ...
                            ELSE 0
                        END) as total_cases
                    FROM call_center.call_entry WHERE LENGTH(callerid) > 4 AND datetime_init between '". $startDate ." 00:00:00' and '". $endDate ." 23:59:59' GROUP BY numberhour) as c"), 'timeslot.timeslot', '=', 'c.numberhour')
