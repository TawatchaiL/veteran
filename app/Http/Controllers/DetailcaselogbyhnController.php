...
class DetailcaselogbyhnController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        ->join('crm_contacts', 'crm_contacts.id', '=', 'crm_caseslogs.contact_id')
        ...
        ->join('crm_cases', 'crm_cases.id', '=', 'crm_case_comments.case_id')
        ->join('crm_contacts', 'crm_contacts.id', '=', 'crm_cases.contact_id')
