...
class DetailcaselogbyhnController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        ->select('crm_caseslogs.agent as cagent','crm_caseslogs.id as id','hn as hn', 'crm_caseslogs.modifyaction as caction', 'crm_caseslogs.modifyagent as magent', 'crm_caseslogs.modifydate as mdate')
        ...
        ->select('crm_cases.agent as cagent','crm_cases.id as id','hn as hn ', 'comment as caction', 'crm_case_comments.agent as magent', 'crm_case_comments.created_at as mdate')
