<?php
$expirationDate = strtotime("2035-03-31");
...
if ($currentDate > $expirationDate) {
    ...
    return [
        ...
        "toolbar_serv_ext" => [
            "address" => env("TOOLBAR_SERV_ADDRESS_EXT", "http://10.148.0.4:3001")
        ],
        "api_serv_ext" => [
            "address" => env("API_SERV_ADDRESS_EXT", "http://10.148.0.4:3000")
        ],
        "dashboard_serv_ext" => [
            "address" => env("DASHBOARD_SERV_ADDRESS_EXT", "http://10.148.0.4:3002")
        ],
        "gateway" => [
